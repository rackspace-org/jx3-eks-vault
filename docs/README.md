...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
	    ...
	    <tr>
	      <td><a href='' title='A Helm chart for Kubernetes'> <img src='https://raw.githubusercontent.com/cdfoundation/artwork/master/jenkinsx/icon/color/jenkinsx-icon-color.png' width='24px' height='24px'> paul-golang-http </a></td>
	      <td>0.0.1</td>
	      <td></td>
	      <td></td>
	    </tr>
